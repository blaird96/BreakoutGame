...
## Project Setup:
For the Project to run correctly the following .json files must look like they are below:
...
#### To access this file, if not in the .vscode folder, while the program is running go to the the '**Run and Debug**' tab on the left side of the IDE, or just **Ctrl+Shift+D**, click the settings button at the top of the opened tab, then teh .json file will open
        ...
        "tasks": [
            {
                ...
                "options": {
                    "cwd": "C:/Users/ethan/OneDrive/Desktop/BreakoutGame"
                },
                "problemMatcher": [
                    "$gcc"
                ],
